...
#define OLED_SCL_H   GPIO_SetBits(OLED_SCL_GPIO_PORT,OLED_SCL_PIN)   //SCL引脚
#define OLED_SDA_H   GPIO_SetBits(OLED_SDA_GPIO_PORT,OLED_SDA_PIN)   //SDA引脚
#define OLED_SCL_L   GPIO_ResetBits(OLED_SCL_GPIO_PORT,OLED_SCL_PIN) //SCL引脚
#define OLED_SDA_L   GPIO_ResetBits(OLED_SDA_GPIO_PORT,OLED_SDA_PIN) //SDA引脚
